	...
	public List<Morido> findAll() {
		...
		try {
			...
			while (myRs.next()) {
				...
				Morido tempMorido = new Morido(id, nombre, apellidos, edad, fechaMoricion, horaMoricion, lugarMoricion,
						causaMoricion);
	...
	public Morido findById(int theId) {
		...
		try (Connection myConn = dataSource.getConnection();
			...
			if (myRs.next()) {
				...
				theMorido = new Morido(theId, nombre, apellidos, edad, fechaMoricion, horaMoricion, lugarMoricion,
						causaMoricion);
